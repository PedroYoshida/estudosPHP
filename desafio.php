                ...
                <form action="" method="post">
                    <div class="form-group row">
                        <div class="col-12 col-sm-6">
                            <input type="number" class="form-control form-control-lg" name="n1" id="n1" placeholder="Primeiro número">
                        </div>
                        <div class="col-12 col-sm-6">
                            <input type="number" class="form-control form-control-lg" name="n2" id="n2" placeholder="Segundo número">
                        </div>
                        <div class="col-12 col-sm-6">
